...
describe('count()', () => {
    ...
    it('counts words with apostrophes', () => {
        const expectedCounts = { 'first': 1, 'don\'t': 2, 'laugh': 1, 'then': 1, 'cry': 1 };
        expect(words.count('First: don\'t laugh. Then: don\'t cry.')).toEqual(expectedCounts);
    });

    it('counts words with quotations', () => {
        const expectedCounts = { 'joe': 1, 'can\'t': 1, 'tell': 1, 'between': 1, 'large': 2, 'and': 1 };
